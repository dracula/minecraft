...
MCVER=(0 1.6.1-1.8.9 1.9–1.10.2 1.11–1.12.2 1.13–1.14.4 1.15–1.16.1 1.16.2–1.16.5 1.17–1.17.1 1.18–1.18.2 1.19–1.19.2 0 0 1.19.3 1.19.4 0 1.20–1.20.1 0 0 1.20.2)
...
for SCALE in 2 3 4 5 6 7 8
do
    for FRMT in 18 15 13 12 9 8 7 6 5 4 3 2 1
    do
        ...
        [ "$FRMT" = 1 ] && \cp -r ./tmp/$SCALE/1.6.1-1.8.9/minecraft ./tmp/$SCALE/assets
        cd ./generated/$FRMT
